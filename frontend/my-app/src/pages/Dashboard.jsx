...
function Dashboard() {
	...
	return (
		<div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
			{/* Sidebar */}
			<aside className="w-72 bg-gradient-to-b from-blue-700 to-blue-900 text-white shadow-2xl p-8 flex flex-col rounded-r-3xl">
				<h2 className="text-3xl font-extrabold mb-10 tracking-wide">Drive Buddy</h2>
				<ul className="flex flex-col gap-6 text-lg font-medium">
					<li className="cursor-pointer hover:text-yellow-300 transition">🚗 Book a Ride</li>
					<li className="cursor-pointer hover:text-yellow-300 transition">🧍 Request a Ride</li>
					<li className="cursor-pointer hover:text-yellow-300 transition">🗓 My Rides</li>
				</ul>
			...
			<main className="flex-1 p-10 flex flex-col gap-10">
				...
				<div className="flex justify-between items-center">
					<h1 className="text-4xl font-extrabold text-gray-800 tracking-tight">
						Welcome, <span className="text-blue-700">{userData ? userData.name : "Loading..."}</span> 👋
					</h1>
				</div>
				...
				<div className="grid grid-cols-3 gap-8">
					...
					<div className="bg-gradient-to-br from-yellow-400 to-yellow-500 shadow-xl p-6 rounded-2xl text-white flex flex-col items-center justify-center hover:scale-105 transition">
						<h3 className="text-lg font-semibold opacity-90">Pending Requests</h3>
					...
					<div className="bg-gradient-to-br from-green-500 to-green-600 shadow-xl p-6 rounded-2xl text-white flex flex-col items-center justify-center hover:scale-105 transition">
						<h3 className="text-lg font-semibold opacity-90">Completed Rides</h3>
				...
				<div className="flex gap-10 flex-1">
					...
					<div className="w-96 bg-white shadow-xl rounded-3xl p-6 flex flex-col gap-5 border border-gray-200">
						<h2 className="text-2xl font-bold text-gray-700 mb-2">Book a Ride</h2>
						<input
							type="text"
						...
						<input
							...
							className="border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
						/>
						<button className="bg-blue-600 text-white px-4 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
							Confirm Booking
						</button>
					</div>
				</div>
